...
pub fn get_shared_files(state: &State, caller: Principal) -> Vec<u64/*PublicFileMetadata */> {
    match state.file_shares.get(&caller) {
        None => vec![],
        Some(file_ids) => file_ids.clone()
            // .iter()
...
//                 username: "John".to_string(),
//                 public_key: vec![1, 2, 3],
//                 canister_id: Principal::from_slice(&[0, 1, 2]),
//             },
//         );
...
//                 username: "John".to_string(),
//                 public_key: vec![1, 2, 3],
//                 canister_id: Principal::from_slice(&[1, 5, 5]),
//             },
//         );
...
//                 username: "John".to_string(),
//                 public_key: vec![1, 2, 3],
//                 canister_id: Principal::from_slice(&[3, 2, 1]),
//             },
//         );
...
//                 username: "John".to_string(),
//                 public_key: vec![1, 2, 3],
//                 canister_id: Principal::from_slice(&[4, 4, 3]),
//             },
//         );
